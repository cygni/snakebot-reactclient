  ...
  return (
    <section>
      ...
      <div className='welcome'>
        ...
        <p>
          This game is a bit different. To play you need to program your own Snake Bot and you will be competing against
          other bots! The concept is simple, your snake can move UP, DOWN, RIGHT or LEFT and the winner is the last
          snake alive. Extra points are awarded when eating stars or nibbling on other snake's tails. Look out for the
          black holes though!
        </p>
        ...
        <p>
          Hack your own Snake Bot and train it in the Training room. From time to time we hold tournaments where you
          will be able to face other player's Snake Bots.
        </p>
      ...
      <div className='getting-started'>
        ...
        <p>
          Your mission is to write the best Snake Bot and survive within the game world. All the boring stuff concerning
        ...
        <p>
          On every Game Tick each Snake Bot receives the current Map. The map contains the positions of all the objects
          in the map.
        </p>
      ...
      <div className='cygni-at-campus'>
        <div>
          ...
          <p>
            Follow @cygniatcampus at Instagram to find out more about the Cygni activities at your Campus and to get
            info about our next Snakebot event.
          </p>
        </div>
